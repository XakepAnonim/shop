    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_subtype', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='products_in_type', to='catalog.productsubtype', verbose_name='Подтип продукта')),
                ('product_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='products_in_subtype', to='catalog.producttype', verbose_name='Тип продукта')),
            ],
            options={
                'verbose_name': 'Товар',
