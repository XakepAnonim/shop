    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('productSubtype', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='products_in_subtype', to='catalog.productsubtype', verbose_name='Подтип продукта')),
                ('productType', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='products_in_type', to='catalog.producttype', verbose_name='Тип продукта')),
            ],
            options={
                'verbose_name': 'Товар',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('products', models.ManyToManyField(related_name='wishlist_products', to='products.product', verbose_name='Продукты')),
            ],
            options={
