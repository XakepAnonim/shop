    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grade', models.PositiveSmallIntegerField(max_length=5, verbose_name='Оценка')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('periods', models.CharField(choices=[(1, 'Менее месяца'), (2, 'Не более года'), (3, 'Более года')], default=1, max_length=16, verbose_name='Срок использования')),
            ],
            options={
                'verbose_name': 'Мнение',
